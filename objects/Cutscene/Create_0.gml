...
sequence_alpha=1;
if false{
opening_text=saveSection+" tutkulu ama yeteneksiz bir musiztendi. Istedigi tek sey insanlarin ilgisi, sevgisi ve parasiydi� Bu gece"+playerName+" meshur muzisyenlerle calacakti, 'Sonunda yetenegimi gostere"+playerName+"...";
