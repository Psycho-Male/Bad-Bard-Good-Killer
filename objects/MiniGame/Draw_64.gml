...
}else if draw_state==1{//Show Score

    DrawSetAlignColor(fa_middle,fa_center,c_white,1);
    draw_text_transformed(Camera.gui_w/2,Camera.gui_h*.20+ftHScaled*0,"Music Score",GUISCALE,GUISCALE,0);
    draw_text_transformed(Camera.gui_w/2,Camera.gui_h*.20+ftHScaled*1.25,scr,GUISCALE+1,GUISCALE+1,0);
    draw_text_transformed(Camera.gui_w/2,Camera.gui_h*.20+ftHScaled*2.5,"Total Score",GUISCALE,GUISCALE,0);
    draw_text_transformed(Camera.gui_w/2,Camera.gui_h*.20+ftHScaled*3.75,SCORE,GUISCALE+1,GUISCALE+1,0);
    draw_sprite_ext(spr_happyface,0,Camera.gui_w/2+48*GUISCALE,Camera.gui_h*.20+ftHScaled*1.5,GUISCALE,GUISCALE,0,c_white,1);
}
