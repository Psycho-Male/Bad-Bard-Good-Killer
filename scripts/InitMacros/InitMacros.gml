...
#macro ftScaled         (ftSize*GUISCALE)
#macro ftWidth          string_width("_")
#macro ftWScaled        (ftWidth*GUISCALE)
#macro ftHeight         string_height("A")
#macro ftHScaled        (ftHeight*GUISCALE)
#macro vk_a                                         ord("A")
#macro vk_s                                         ord("S")
#macro vk_d                                         ord("D")
#macro vk_f                                         ord("F")
...
Trace("Initialize function macros...",LOGLEVEL.INFO);
#macro str          string
...
#macro Destroy          instance_destroy
...
#macro sprWidthScaled   (sprWidth)*guiScale
#macro sprHeightScaled  (sprHeight)*guiScale
#macro AssetIndex       asset_get_index

#macro drawEvent (event_number==ev_gui||event_number==ev_gui_end||event_number==ev_gui_begin)

#macro plIndex      PLAYER.index
